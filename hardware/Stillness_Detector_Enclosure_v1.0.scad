...
pcbLength           = 49; // front to back (X axis)
pcbWidth            = 70.5; // side to side (Y axis)
pcbThickness        = 1.6;
...
standoffHeight      = 5.0;  //-- used for PCB Supports, Push Button and showPCB
standoffDiameter    = 6;
standoffPinDiameter = 1.9;
...
showOriginCoordBox        = true;      //-> Shows red bars representing the origin for yappCoordBox : only in preview 
...
pcbStands = 
[
//- Add three stands with pins and one without
    [2.7,17.8],
    [2.7, 67.96],
    [46.3, 67.96],
//    [46.3, 2.7, standoffHeight,-1,standoffDiameter,standoffPinDiameter-1,standoffHoleSlack,0,0, yappBaseOnly,yappPin]
...
cutoutsFront =  
[
[7, -0.4, 12.5, 8, 1, yappRoundedRect]
,[20.5, -0.4, 12.5, 8, 1, yappRoundedRect]
];
...
cutoutsLeft =   
[
[19.5, 11.1, 12, 8, 1, yappRoundedRect],
[1, 1.6, 12, 6, 1, yappRoundedRect]
];

cutoutsRight =  
[
[30, 2.1, 10.2, 6.6, 3, yappRoundedRect],
[27, 10.7, 16.2, 2, 1, yappRoundedRect, 2.5, 0, yappFromInside],
[9.5, 0.6, 1, 1, 5, yappCircle],
//[9, 0, 20, 6, 1, yappRoundedRect] // original sensors cutout
];
...
[
  [34, 64,    // [0,1] Pos
    6, 9.5,                   // [2,3] Length, Width
    1,                      // [4]   wall thickness
    2,                      // [5] Gap above base bottom
...
labelsPlane =
[
    [13.5, 15, 0, -1, yappFront, "Liberation Mono:style=bold", 3, "Out" ],
    [28, 15, 0, -1, yappFront, "Liberation Mono:style=bold", 3, "In" ],
    [6, 4.4, 0, -1, yappLeft, "Liberation Mono:style=bold", 3, "Data" ],
    [23.5, 14, 0, -1, yappLeft, "Liberation Mono:style=bold", 3, "Power" ],
    [34.66, 5, 0, -1, yappRight, "Liberation Mono:style=bold", 3, "PIR" ],
    [14.33, 5, 0, -1, yappRight, "Liberation Mono:style=bold", 3, "TOF" ]
];
...
module hookBaseInside()
{
  ...
  translate([48.3, 4.7, 0])
  {
    color("green") 
    {
      cylinder(h=5, d1=6, d2=6, center=false);;
    }
  }
  
  translate([44.95, 104.5 , 10.2])
  rotate([90, 0, 0]) 
  {
    color("blue") 
    {
      cylinder(h=4, d1=1.5, d2=1.5, center=false);;
    }
  }
  
  translate([29.25, 104.5 , 10.2])
  rotate([90, 0, 0]) 
  {
    color("blue") 
    {
